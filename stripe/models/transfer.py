...
TRANSFER_FAILURE_CHOICES = (
    ...
    ('account_closed', _('The bank account has been closed.')),
    (
        'no_account',
        _(
    ...
    ('account_frozen', _('The bank account has been frozen.')),
    ('could_not_process', _('The bank could not process this transfer.')),
    (
